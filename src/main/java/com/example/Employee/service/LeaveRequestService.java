...
public class LeaveRequestService {
    ...
    public ResponseEntity<Object> createLeaveRequest(CreateLeaveRequestDto dto) {
        ...
        boolean overlaps = !leaveRequestRepository.findByEmployeeIdAndStartDateLessThanEqualAndEndDateGreaterThanEqual(
        dto.getEmployeeId(), dto.getEndDate(), dto.getStartDate()).isEmpty();
    ...
    public ResponseEntity<Object> getLeaveRequestById(Long id) {
        ...
        return ResponseUtil.build(HttpStatus.OK, "Leave request fetched successfully", toResponseDto(leaveRequest));
    }
    ...
    private LeaveRequest toEntity(CreateLeaveRequestDto dto) {
        ...
        return new LeaveRequest(dto.getStartDate(), dto.getEndDate(), LeaveStatus.PENDING , employee);
    }
